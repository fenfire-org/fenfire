...
public Object find1_X1A(Object e0, Obs obs) {
    return graph.find1_X1AA(e0, obs);
}
public Iterator findN_X1A_Iter(Object e0, Obs obs){
    return graph.findN_X1AA_Iter(e0, obs);
}
