...
public Object find1_11AX(Object subj, Object pred) {
    return constgraph.find1_11AX(subj, pred, obs);
}
public Object find1_11AX(Object subj, Object pred, Obs obs) {
    throw new Error("DoubleObs");
}
public Iterator findN_11AX_Iter(Object subj, Object pred) {
    return constgraph.findN_11AX_Iter(subj, pred, obs);
}
