...
/** Factory which products main views than can handle text.
 */
public class EditorViewFactory implements MainViewFactory {

    boolean checked = false;
    Object node = null;
    Graph g;
    FServer f;
    public EditorViewFactory(FServer f, Graph g) {
	this.g = g;
	this.f = f;
    }
	...
	//return new EditorMainView(f, node);
